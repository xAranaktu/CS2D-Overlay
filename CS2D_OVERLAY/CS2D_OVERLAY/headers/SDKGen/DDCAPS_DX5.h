...
struct DDCAPS_DX5Decl {
    void* pSuper;  // 0x0 0x7C7BE0
    void* pFree;  // 0x4 0x5926E0
    BBDebugScope* pDebugScope; // 0x8
    size_t sz; //0xC 372(0x174)
    int(__cdecl* m_DDCAPS_DX5_New)(DDCAPS_DX5* pThis); // [New at 0x7A3CFD] [0x10] ()i
    int(__cdecl* m_DDCAPS_DX5_Delete)(DDCAPS_DX5* pThis); // [Delete at 0x7A4053] [0x14] ()i
};


// 91 members
struct DDCAPS_DX5 {
    DDCAPS_DX5Decl* decl; // 0x0
    int    refs;  // 0x4
