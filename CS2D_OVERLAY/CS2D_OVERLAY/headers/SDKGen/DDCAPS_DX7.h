...
struct DDCAPS_DX7Decl {
    void* pSuper;  // 0x0 0x7C7BE0
    void* pFree;  // 0x4 0x5926E0
    BBDebugScope* pDebugScope; // 0x8
    size_t sz; //0xC 388(0x184)
    int(__cdecl* m_DDCAPS_DX7_New)(DDCAPS_DX7* pThis); // [New at 0x7A43ED] [0x10] ()i
    int(__cdecl* m_DDCAPS_DX7_Delete)(DDCAPS_DX7* pThis); // [Delete at 0x7A476B] [0x14] ()i
};


// 95 members
struct DDCAPS_DX7 {
    DDCAPS_DX7Decl* decl; // 0x0
    int    refs;  // 0x4
