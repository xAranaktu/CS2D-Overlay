...
struct DDCAPS_DX6Decl {
    void* pSuper;  // 0x0 0x7C7BE0
    void* pFree;  // 0x4 0x5926E0
    BBDebugScope* pDebugScope; // 0x8
    size_t sz; //0xC 388(0x184)
    int(__cdecl* m_DDCAPS_DX6_New)(DDCAPS_DX6* pThis); // [New at 0x7A4061] [0x10] ()i
    int(__cdecl* m_DDCAPS_DX6_Delete)(DDCAPS_DX6* pThis); // [Delete at 0x7A43DF] [0x14] ()i
};


// 95 members
struct DDCAPS_DX6 {
    DDCAPS_DX6Decl* decl; // 0x0
    int    refs;  // 0x4
    ...
    int m_dwMaxVideoPorts; // 0x138 <type_i>
    int m_dwCurrVideoPorts; // 0x13C <type_i>
    int m_dwSVBCaps2; // 0x140 <type_i>
    int m_dwNLVBCaps; // 0x144 <type_i>
    int m_dwNLVBCaps2; // 0x148 <type_i>
    int m_dwNLVBCKeyCaps; // 0x14C <type_i>
    int m_dwNLVBFXCaps; // 0x150 <type_i>
    int m_dwNLVBRops_0; // 0x154 <type_i>
    int m_dwNLVBRops_1; // 0x158 <type_i>
    int m_dwNLVBRops_2; // 0x15C <type_i>
    int m_dwNLVBRops_3; // 0x160 <type_i>
    int m_dwNLVBRops_4; // 0x164 <type_i>
    int m_dwNLVBRops_5; // 0x168 <type_i>
    int m_dwNLVBRops_6; // 0x16C <type_i>
    int m_dwNLVBRops_7; // 0x170 <type_i>
    int m_ddsCaps_0; // 0x174 <type_i>
    int m_ddsCaps_1; // 0x178 <type_i>
    int m_ddsCaps_2; // 0x17C <type_i>
    int m_ddsCaps_3; // 0x180 <type_i>
};
