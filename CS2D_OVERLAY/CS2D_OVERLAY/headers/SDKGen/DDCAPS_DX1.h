...
struct DDCAPS_DX1Decl {
    void* pSuper;  // 0x0 0x7C7BE0
    void* pFree;  // 0x4 0x5926E0
    BBDebugScope* pDebugScope; // 0x8
    size_t sz; //0xC 180(0xB4)
    int(__cdecl* m_DDCAPS_DX1_New)(DDCAPS_DX1* pThis); // [New at 0x7A388D] [0x10] ()i
    int(__cdecl* m_DDCAPS_DX1_Delete)(DDCAPS_DX1* pThis); // [Delete at 0x7A3A03] [0x14] ()i
};


// 43 members
struct DDCAPS_DX1 {
    DDCAPS_DX1Decl* decl; // 0x0
    int    refs;  // 0x4
